...
function clearInputMoney(field) {
    let clearInput = document.getElementById(field + '-money');
    clearInput.value = '';

}
function clearCalculateMoney(field) {
    let clearCalculation = document.getElementById(field);
    clearCalculation.innerText = 0;

}
document.getElementById('clearBtn').addEventListener('click', function () {
    clearInputMoney('income');
    clearInputMoney('food');
    clearInputMoney('rent');
    clearInputMoney('clothes');
    clearInputMoney('save-Percent');
    clearCalculateMoney('total-money');
    clearCalculateMoney('balance');
    clearCalculateMoney('save-money');
    clearCalculateMoney('reamining-balance');
})